...
public class App {
    public static void main(String[] args) throws InterruptedException {
        if (args.length == 2) {
            ...
            testchain2 = Input.parseBlockFile(args[0]);
            ...
            String merkleRoot6 = Hash.getMerkleTree(ledger6, ledger6.size() - 1)[0];
            ...
            // Check if the block is good or bad based on whether the block exists in the blockchain
